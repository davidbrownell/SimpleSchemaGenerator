...
| --- | --- | --- |
| 1. Clone the repository locally. | `git clone https://github.com/davidbrownell/SimpleSchemaGenerator` | https://git-scm.com/docs/git-clone |
