...
from ....Common.Error import ExceptionError, SimpleSchemaGeneratorException
from .... import Errors
    ...
    def Validate(
        ...
        def Impl(
            ...
            if self.is_container:
                ...
                # We don't have enough context to validate the cardinality now, but it will be
        ...
        if isinstance(expression_or_value, Expression):
            try:
                ...
                # BugBug: This statement loses expression_or_value's region
